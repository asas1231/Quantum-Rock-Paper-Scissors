...
if not st.session_state.game_over:
    ...
    elif wc >= 9: win_count_state = "看來進入大成之境，繼續朝著大道合一前行吧🎉"
    elif wc >= 7: win_count_state = "不錯喔，漸入佳境，是不是有抓到感覺了🎉"
    elif wc >= 5: win_count_state = "在猜拳之道，小有所成🎉 "
    elif wc >= 3: win_count_state = "看來悟到了些皮毛🎉"
...
if st.session_state.history:
    ...
    st.dataframe(
        df.sort_values(by="連勝", ascending=False), 
